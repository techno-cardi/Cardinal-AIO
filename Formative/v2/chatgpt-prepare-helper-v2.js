(() => {
  ...
  const COMPACT_PROTOCOL = [
    ...
    'Images/tableaux/extraits/médias: conserve la dépendance. Source nécessaire absente => grading.provenance.kind="sourceMissing" + SOURCE_REQUIRED ou MEDIA_DEPENDENCY_MISSING.',
    '',
    'CONTRÔLE FINAL',
